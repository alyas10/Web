...
def models():
    ...
    return render_template('pipeline.html', models=ml_models)
...
def results():
    ...
    class_metrics = [
        {'class': 'DoS/DDoS', 'precision': '98.2%', 'recall': '97.5%', 'f1_score': '97.8%', 'support': 2453,
         'type': 'attack'},
        {'class': 'Intrusion', 'precision': '94.7%', 'recall': '93.1%', 'f1_score': '93.9%', 'support': 1847,
         'type': 'attack'},
        {'class': 'Anomaly', 'precision': '91.3%', 'recall': '89.8%', 'f1_score': '90.5%', 'support': 892,
         'type': 'attack'},
        {'class': 'Benign', 'precision': '99.1%', 'recall': '99.4%', 'f1_score': '99.2%', 'support': 8763,
         'type': 'benign'},
    ]
